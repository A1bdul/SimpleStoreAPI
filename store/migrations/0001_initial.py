# Generated by Django 3.2.16 on 2023-01-08 00:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('label', models.CharField(choices=[('NEW', 'N'), ('SALE', 'S')], default='SALE', max_length=10)),
                ('description', models.TextField()),
                ('category', models.CharField(choices=[('Accessories', 'accessories'), ('Camera & Photos', 'camera & photos'), ('Computer & Laptop', 'computer & laptop'), ('TV & Audio', 'tv & audio'), ('uncategorized', 'Uncategorized')], default='uncategorized', max_length=200)),
            ],
        ),
        migrations.CreateModel(
            name='OrderedItem',
