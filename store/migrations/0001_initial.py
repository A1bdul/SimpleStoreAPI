# Generated by Django 3.2.16 on 2023-01-10 05:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('label', models.CharField(choices=[('NEW', 'New'), ('SALE', 'Sale'), ('FEATURED', 'Featured')], default='SALE', max_length=10)),
                ('description', models.TextField()),
                ('category', models.CharField(blank=True, choices=[('Accessories', 'Accessories'), ('Camera & Photos', 'Camera & hotos'), ('Computer & Laptop', 'Computer & Laptop'), ('TV & Audio', 'Tv & Audio'), ('Electronic & Housewares', 'Electronic & Housewares'), ('Smartphone & Tablet', 'Smartphone & Tablet'), ('Games & Console', 'Games & Console')], max_length=200)),
            ],
        ),
        migrations.CreateModel(
            name='OrderedItem',
