    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('label', models.CharField(choices=[('N', 'NEW'), ('S', 'SALE')], default='SALE', max_length=10)),
            ],
        ),
        migrations.CreateModel(
            name='OrderedItem',
            fields=[
                ...
                ('item', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='ordered_item', to='store.product')),
            ],
        ),
        migrations.CreateModel(
            name='Cart',
            fields=[
                ...
                ('items', models.ManyToManyField(to='store.ordereditem')),
            ],
        ),
        migrations.AddField(
            model_name='user',
